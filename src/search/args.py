...
class Parser(object):
    def __init__(self):
        ...
        parser.add_argument('--resume_file',             type=str,            default='/data/wl4u19/experiments/search_logs/s1/cifar10/0.0_0.0003-1/checkpoint.pth.tar',          help='resume search path')
        ...
        # logging options
        parser.add_argument('--save',                    type=str,            default='/data/wl4u19/experiments/search_logs',  help='experiment name')
        ...
        # early stopping
        parser.add_argument('--early_stop',              type=int,            default=3,              choices=[0, 1, 2, 3],
